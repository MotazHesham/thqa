    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buildings.update", [$building->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('owner') ? 'is-invalid' : '' }}" name="owner_id" id="owner_id" required>
                    @foreach($owners as $id => $entry)
                        <option value="{{ $id }}" {{ (old('owner_id') ? old('owner_id') : $building->owner->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('owner'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('map_lat') ? 'is-invalid' : '' }}" type="text" name="map_lat" id="map_lat" value="{{ old('map_lat', $building->map_lat) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('map_long') ? 'is-invalid' : '' }}" type="text" name="map_long" id="map_long" value="{{ old('map_long', $building->map_long) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $building->address) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('building_type') ? 'is-invalid' : '' }}" name="building_type" id="building_type" required>
                    ...
                    @foreach(App\Models\Building::BUILDING_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('building_type', $building->building_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('building_status') ? 'is-invalid' : '' }}" name="building_status" id="building_status" required>
                    ...
                    @foreach(App\Models\Building::BUILDING_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('building_status', $building->building_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('owned_date') ? 'is-invalid' : '' }}" type="text" name="owned_date" id="owned_date" value="{{ old('owned_date', $building->owned_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('registration_date') ? 'is-invalid' : '' }}" type="text" name="registration_date" id="registration_date" value="{{ old('registration_date', $building->registration_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('survey_descision') ? 'is-invalid' : '' }}" type="text" name="survey_descision" id="survey_descision" value="{{ old('survey_descision', $building->survey_descision) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commerical_num') ? 'is-invalid' : '' }}" type="text" name="commerical_num" id="commerical_num" value="{{ old('commerical_num', $building->commerical_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('real_estate_identity') ? 'is-invalid' : '' }}" type="text" name="real_estate_identity" id="real_estate_identity" value="{{ old('real_estate_identity', $building->real_estate_identity) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('employee') ? 'is-invalid' : '' }}" name="employee_id" id="employee_id">
                    @foreach($employees as $id => $entry)
                        <option value="{{ $id }}" {{ (old('employee_id') ? old('employee_id') : $building->employee->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id">
                    @foreach($countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $building->country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
