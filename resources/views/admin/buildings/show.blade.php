                        ...
                        <div class="col-lg-4">
                            <div class="pd-img-wrapp position-relative mb-5 mb-lg-0">
                                @foreach($building->photos as $media)
                                    @if($loop->first)
                                        <img id="img_01" src="{{ $media->getUrl() }}" data-zoom-image="{{ $media->getUrl() }}"
                                            alt="" />
                                    @endif
                                @endforeach
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="product-details-content position-relative">
                                ...
                                <!-- Product Price -->
                                <p class="price">
                                    <span>{{ App\Models\Building::BUILDING_TYPE_SELECT[$building->building_type] ?? '' }} </span>
                                </p>
                                <!-- End Product Price -->
                                <!-- End Product Review -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="review-list mb-20">
                                                ...
                                                <span class="black">    
                                                    {{ $building->address }} - {{ $building->country->name ?? ''}} , {{ $building->city->name ?? '' }}
                                                </span>
                                            </div>
                                            <!-- End Form Group -->
                                            <!-- Form Group -->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="review-list mb-20">
                                                ...
                                                <span class="black">{{ $owner->gender ? App\Models\Owner::GENDER_SELECT[$owner->gender] : '' }}</span>
                                            </div>
                                            <!-- End Form Group -->
                                            <!-- Form Group -->
                                            <div class="review-list mb-20">
                                        ...
                                        <tbody>
                                            @foreach($building->buildingBuildingSaks as $sak)
                                                <tr>
                                                    <td>{{ $sak->sak_num }}</td> 
                                                    <td>
                                                        <a href="{{ $sak->photo ? $sak->photo->getUrl() : '' }}" class="details-btn">عرض
                                        ...
                                        <tbody>
                                            @foreach($building->buildingBuildingDocuments as $document)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ $document->photo ? $document->photo->getUrl() : '' }}" class="details-btn">عرض
                                                            <i class="icofont-arrow-left"></i></a>
                                                    </td>
                                                </tr> 
                                            @endforeach
